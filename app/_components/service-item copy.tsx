...
export function ServiceItem({ service }: ServiceItemProps) {
  ...
  return (
    <Sheet open={sheetIsOpen} onOpenChange={handleSheetChange}>
        ...
        <div className="flex h-full flex-col gap-6">
          ...
          {selectedDate && (
            <>
              ...
              {/* <div className="flex min-h-[100px] gap-3 overflow-x-auto px-5 [&::-webkit-scrollbar]:hidden">
              ...
              <div className="grid grid-cols-4 gap-3 px-5">
                {/* <div className="mx-auto grid w-fit grid-cols-4 gap-3 px-5"> */}
                {availableTimeSlots?.data?.map((time) => (
                  <Button
                    key={time}
                    variant={selectedTime === time ? "default" : "outline"}
      ...
      {/*
      <SheetContent side="left" className="w-[370px] overflow-y-auto p-0">
